...
<<<<<<< HEAD
      ...
      <header className="w-full p-6 flex justify-between items-center bg-gray-800 fixed top-0 z-50">
        ...
        {/* ✅ FIXED ROUTE PATHS HERE */}
        <nav className="flex gap-6 text-lg">
          <Link to="/" className="hover:text-blue-400">Home</Link>
          <Link to="/dashboard/videoanalysis" className="hover:text-blue-400">Video Analysis</Link>
      ...
      <main className="pt-28 px-8">
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-300 mb-6">
            NSG operates multiple surveillance systems including drones, body cams, and mobile robots. 
            Our AI-powered software analyses video feeds, identifies threats, and generates actionable insights.
          </p>
        </section>
...
<<<<<<< HEAD
              Automates extraction of insights from video feeds, detects unusual behaviors, 
              identifies objects, and tracks movements with minimal human intervention.
            </p>
          </div>
          ...
          <div className="p-6 bg-gray-800 rounded-2xl shadow-lg">
            ...
            <p className="text-gray-300">
              Recognizes weapons, explosives, loitering, suspicious movements, and triggers 
              instant alerts for actionable decisions.
            </p>
          </div>
          ...
          <div className="p-6 bg-gray-800 rounded-2xl shadow-lg">
            ...
            <p className="text-gray-300">
              Identifies individuals of interest, compares against watchlists, 
              and tracks their movement to enhance security monitoring.
            </p>
          </div>
          ...
          <div className="p-6 bg-gray-800 rounded-2xl shadow-lg">
            ...
            <p className="text-gray-300">
              Can receive video inputs from existing surveillance devices without the need 
              for costly upgrades, ensuring maximum utilization.
=======
...
<<<<<<< HEAD
            ...
            <div className="p-6 bg-gray-800 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-300">
                Historical data visualization and predictive insights from video footage.
              </p>
            </div>
            ...
            <div className="p-6 bg-gray-800 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-300">
                Visual representation of high-activity zones and crowd movements.
              </p>
            </div>
